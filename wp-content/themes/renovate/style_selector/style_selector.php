...
<div class="style-selector<?php echo (isset($_COOKIE['re_style_selector']) ? ' ' . esc_attr($_COOKIE['re_style_selector']) : ' opened'); ?>">
		...
		<ul>
			...
			<li class="clearfix">
				...
				<select name="style_selector_direction">
					<option value="LTR"<?php echo (!isset($_COOKIE['re_direction']) || $_COOKIE['re_direction']=="LTR" ? ' selected="selected"' : ''); ?>><?php _e("LTR", 'renovate'); ?></option>
					<option value="RTL"<?php echo ((!isset($_COOKIE['re_direction']) && $theme_options["direction"]=="rtl") || (isset($_COOKIE['re_direction']) && $_COOKIE['re_direction']=="RTL") ? ' selected="selected"' : ''); ?>><?php _e("RTL", 'renovate'); ?></option>
				</select>
			</li>
			<li>
