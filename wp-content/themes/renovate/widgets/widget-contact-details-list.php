...
class re_contact_details_list_widget extends WP_Widget 
{
	...
	{	
		...
		<p class="widget-border">
			<label for="<?php echo esc_attr($this->get_field_id('icon')) . absint($i); ?>"><?php _e('Icon', 'renovate'); ?></label>
			...
			<label for="<?php echo esc_attr($this->get_field_id('text')) . absint($i); ?>"><?php _e('Text', 'renovate'); ?></label>
			...
			<br>
			<label for="<?php echo esc_attr($this->get_field_id('url')) . absint($i); ?>"><?php _e('Url', 'renovate'); ?></label>
			...
			<label for="<?php echo esc_attr($this->get_field_id('target')) . absint($i); ?>"><?php _e('Url target', 'renovate'); ?></label>
...
//register widget
function re_contact_details_list_widget_init()
{
	return register_widget("re_contact_details_list_widget");
}
add_action('widgets_init', 're_contact_details_list_widget_init');
?>