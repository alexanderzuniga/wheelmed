...
class re_list_widget extends WP_Widget 
{
	...
	{	
		...
		<p class="widget-border">
			<label for="<?php echo esc_attr($this->get_field_id('list_item')) . absint($i); ?>"><?php _e('List item text', 'renovate'); ?></label>
			...
			<label for="<?php echo esc_attr($this->get_field_id('list_item_url')) . absint($i); ?>"><?php _e('List item url', 'renovate'); ?></label>
			...
			<label for="<?php echo esc_attr($this->get_field_id('list_item_target')) . absint($i); ?>"><?php _e('List item url target', 'renovate'); ?></label>
...
//register widget
function re_list_widget_init()
{
	return register_widget("re_list_widget");
}
add_action('widgets_init', 're_list_widget_init');
?>