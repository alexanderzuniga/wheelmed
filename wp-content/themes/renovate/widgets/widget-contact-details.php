...
class re_contact_details_widget extends WP_Widget 
{
	...
	{	
		...
		?>
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('icon_type')) . absint($i); ?>"><?php _e('Icon type', 'renovate'); ?></label>
...
//register widget
function re_contact_details_widget_init()
{
	return register_widget("re_contact_details_widget");
}
add_action('widgets_init', 're_contact_details_widget_init');
?>