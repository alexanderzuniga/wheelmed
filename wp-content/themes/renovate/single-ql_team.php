...
<div class="theme-page padding-bottom-70">
	...
	<div class="clearfix">
		...
		else
		{
			...
			echo '<div class="vc_row wpb_row vc_row-fluid full-width page-margin-top-section"><div class="vc_col-sm-12 wpb_column vc_column_container">' . re_theme_single_team(array()) . '</div></div>';
		}
		?>
	</div>
</div>
